...
//    Kode dibawah ini untuk memerintahkan aplikasi MainActivity akan dijalankan sebelum melakukan test.
    @Before
    fun setup(){
...
//        Sebuah view dengan id edt_length diberi tindakan input dengan sebuah teks dummyLength dan menutup secara berlahan keyboard Android.
